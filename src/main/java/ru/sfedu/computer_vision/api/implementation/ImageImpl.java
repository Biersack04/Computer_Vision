...
*/
    ...
    public void saveMatToFile(String imageName, Mat img) {
        try {
          //  log.info("imageName - ",imageName);
            //log.info("Constants.IMAGE_PATH - ",Constants.IMAGE_PATH.toString());
            final String modFilePath = buildImageName(Constants.IMAGE_PATH,imageName); //D:/computerVision/src/main/resources/images/testimage.jpg.jpg
    ...
    private String buildImageName(String imPath, String name) {
        log.info(imPath);//D:/computerVision/src/main/resources/images
        log.info(name);//testimage.jpg
